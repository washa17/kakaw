...
/**
 * Atualiza nome e whatsapp de um cliente de uma vez.
 * whatsapp pode vir vazio ("") para indicar "sem número cadastrado".
 */
async function atualizarCliente(id, novoNome, whatsapp) {
  await updateDoc(doc(db, ...COL_CLIENTES, id), {
    nome: novoNome,
...
window.kakawClientes = {
  listarClientes, renomearCliente, atualizarCliente, excluirCliente,
